...
\title[Lokale GPU rekenkracht beschikbaar in de browser]%
...
\input{./texparts/longlist.tex}
\input{./texparts/shotlist.tex}
...
\begin{figure}
    \includegraphics[width=\linewidth]{WhisperRatchetWin.PNG}
...
\begin{figure}
    \includegraphics[width=\linewidth]{WhisperTurbo.PNG}
    \caption[Whisper Turbo \autocite{Fleetwood2023b}]{
        Whisper Turbo geïmplementeerd door \textcite{Fleetwood2024}
    }
